...
def cfg():
    ...
    parser.add_argument('--modelname', default='continue_base_model', help='define model name')
    ...
    with open(txt_name, mode='w') as txt_write:
        ...
        for epoch in range(opt.start_iter, opt.nEpochs + 1):
            ...
            for iteration, batch in enumerate(training_data_loader, 1):
                ...
                L1_reg=0
                loss = 1*ssim_loss +1*p_loss + 1*smoothloss  
                if epoch>100:
                    L1_reg=L1_regularization(lighten)
                    loss=loss+L1_reg
                ...
                writer.add_scalar('L1_reg', L1_reg, over_Iter)
